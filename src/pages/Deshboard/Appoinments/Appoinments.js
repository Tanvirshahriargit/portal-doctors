...
const Appoinments = ({ date }) => {
    ...
    useEffect(() => {
        const url = `https://shrouded-retreat-34385.herokuapp.com/appointments?email=${user.email}&date=${date.toLocaleDateString()}`
        fetch(url, {
            headers: {
    ...
    return (
        <div>
            ...
            <TableContainer component={Paper}>
                <Table sx={{  }} aria-label="Appointsments table">
                    <TableHead>
                        <TableRow>
